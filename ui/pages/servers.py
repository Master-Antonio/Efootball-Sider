...
class ServersPage(QWidget):
    ...
    def __init__(self, context: AppContext, parent: QWidget | None = None) -> None:
        ...
        self.banner = StatusBanner(
            "Questi folder organizzano gli asset per Team ID / Stadio. L'iniezione runtime "
            "per-ID non \u00e8 ancora implementata: per sostituire contenitori usa "
            "'Build Zen Triplet' nella pagina Mods.",
            "info",
        )
